...
export default function Captura() {
  ...
  const inputClass = "w-full px-4 py-2.5 text-xs bg-neutral-50/60 dark:bg-[#1b2230] border border-neutral-200/80 dark:border-neutral-800 rounded-xl outline-none focus:ring-4 focus:ring-b2bHighlight/10 focus:border-b2bHighlight focus:bg-white dark:focus:bg-[#151922] transition-all placeholder:text-neutral-450 dark:placeholder:text-neutral-500 text-neutral-800 dark:text-white font-semibold";
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 pb-16">
      ...
      {/* Selector de Sección */}
      <div className="flex gap-2 bg-neutral-100 dark:bg-[#151922] p-1.5 rounded-2xl w-full border border-neutral-200 dark:border-neutral-800/80">
        <button 
          onClick={() => setSeccionActiva('banco')} 
          className={`flex-1 py-2.5 text-[11px] font-black uppercase tracking-widest rounded-xl transition-all flex items-center justify-center gap-2 ${seccionActiva === 'banco' ? 'bg-white dark:bg-[#1c2333] text-neutral-900 dark:text-white shadow-sm dark:shadow-none' : 'text-neutral-550 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white'}`}
        >
          <FileSpreadsheet size={14} /> Conciliación Diaria (Bancos)
        </button>
        <button 
          onClick={() => setSeccionActiva('sat')} 
          className={`flex-1 py-2.5 text-[11px] font-black uppercase tracking-widest rounded-xl transition-all flex items-center justify-center gap-2 ${seccionActiva === 'sat' ? 'bg-white dark:bg-[#1c2333] text-neutral-900 dark:text-white shadow-sm dark:shadow-none' : 'text-neutral-550 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white'}`}
        >
      ...
      <AnimatePresence mode="wait">
        {seccionActiva === 'banco' ? (
          ...
          >
            ...
            <motion.div 
              whileHover={{ y: -2 }}
              className={`relative p-8 rounded-3xl border-2 border-dashed text-center transition-all ${dragBanco ? 'border-b2bHighlight bg-b2bHighlight/5' : archivoBanco ? 'border-emerald-250 dark:border-[#00C49F]/30 bg-emerald-50/20 dark:bg-[#00C49F]/5' : 'border-neutral-200 dark:border-neutral-800 bg-white dark:bg-[#151922]/50 hover:border-neutral-350 dark:hover:border-neutral-700'}`}
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center space-y-4">
                <div className={`p-3.5 rounded-2xl ${archivoBanco ? 'bg-emerald-100/50 dark:bg-[#00C49F]/20 text-emerald-600 dark:text-[#00e5bc]' : 'bg-neutral-50 dark:bg-neutral-800 border border-neutral-200/40 dark:border-neutral-750 text-neutral-550 dark:text-neutral-400'}`}>
                ...
                <div>
                  ...
                  <p className="text-[11px] text-neutral-500 dark:text-neutral-400 font-medium mt-1">
            ...
            <motion.div 
              ...
              className="bg-white dark:bg-[#151922]/50 p-10 rounded-3xl border border-neutral-200 dark:border-neutral-800/80 shadow-premium-sm dark:shadow-none"
            >
              <div className="flex items-center gap-4 mb-8 pb-4 border-b border-neutral-100 dark:border-neutral-800/60">
                <div className="p-2.5 bg-neutral-900 dark:bg-[#1c2333] text-white rounded-xl shadow-premium-sm border dark:border-neutral-800"><CircleDollarSign size={18} /></div>
                <h2 className="text-sm font-black text-neutral-900 dark:text-white uppercase tracking-widest font-title">Cierre de Caja</h2>
              </div>
              ...
              <form onSubmit={guardarFlujo} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <span className="absolute left-4 top-3 text-neutral-400 text-xs">$</span>
                      <input type="number" required step="0.01" value={formulario.monto_depositado} onChange={e => setFormulario({...formulario, monto_depositado: e.target.value})} className={inputClass + " pl-8 font-black text-neutral-900 dark:text-white"} placeholder="0.00" />
                    </div>
                  </div>
                </div>

                <div className="p-6 bg-neutral-50/65 dark:bg-[#1b2230]/40 rounded-2xl border border-neutral-200/30 dark:border-neutral-800/40 space-y-5">
                  <div className="flex items-center gap-2 mb-1">
                    <ShieldCheck size={14} className="text-neutral-500 dark:text-neutral-400" />
                    <h3 className="text-[10px] font-bold text-neutral-500 dark:text-neutral-400 uppercase tracking-widest">Deducciones de Terminal</h3>
                  </div>
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      <label className="block text-[9px] font-bold text-neutral-450 dark:text-neutral-500 uppercase mb-2 ml-0.5">Clip</label>
                    ...
                    <div>
                      <label className="block text-[9px] font-bold text-neutral-450 dark:text-neutral-500 uppercase mb-2 ml-0.5">Mercado Pago</label>
                    ...
                    <div>
                      <label className="block text-[9px] font-bold text-neutral-450 dark:text-neutral-500 uppercase mb-2 ml-0.5">ISR / IVA (SAT)</label>
                ...
                <motion.button whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }} type="submit" className="w-full py-3.5 bg-[#00C49F] hover:bg-emerald-500 text-white text-xs font-black uppercase tracking-widest rounded-xl transition-all shadow-md flex items-center justify-center gap-2 border border-[#00C49F]/10"><Save size={15} /> Persistir Registro</motion.button>
              </form>
            </motion.div>
          </motion.div>
        ) : (
          ...
          >
            ...
            <motion.div 
              whileHover={{ y: -2 }}
              className={`relative p-10 rounded-3xl border-2 border-dashed text-center transition-all ${dragSat ? 'border-b2bHighlight bg-b2bHighlight/5' : xmlCargados.length > 0 ? 'border-[#00C49F]/30 bg-emerald-50/20 dark:bg-emerald-500/5' : 'border-neutral-200 dark:border-neutral-800 bg-white dark:bg-[#151922]/50 hover:border-neutral-350 dark:hover:border-neutral-700'}`}
            ...
            >
              ...
              />
              <div className="flex flex-col items-center justify-center space-y-4">
                <div className={`p-3.5 rounded-2xl ${xmlCargados.length > 0 ? 'bg-emerald-100/50 dark:bg-emerald-500/20 text-[#00C49F] dark:text-[#00e5bc] border border-emerald-250 dark:border-[#00C49F]/20' : 'bg-neutral-50 dark:bg-neutral-800 border border-neutral-200/40 dark:border-neutral-750 text-neutral-550 dark:text-neutral-400'}`}>
                ...
                <div>
                  ...
                  <p className="text-[11px] text-neutral-550 dark:text-neutral-400 font-medium mt-1 leading-relaxed">
            ...
            {xmlCargados.length > 0 && (
              <div className="bg-white dark:bg-[#151922]/50 p-6 rounded-3xl border border-neutral-200 dark:border-neutral-800/80 shadow-premium-sm dark:shadow-none space-y-3">
                <h4 className="text-[10px] font-black text-neutral-550 dark:text-neutral-500 uppercase tracking-widest border-b border-neutral-100 dark:border-neutral-850/60 pb-2">Historial de Carga Reciente</h4>
                <div className="max-h-40 overflow-y-auto space-y-1.5 font-mono text-[10px] text-neutral-600 dark:text-neutral-450">
                  {xmlCargados.map((name, idx) => (
                    <div key={idx} className="flex justify-between py-1 border-b border-neutral-50 dark:border-neutral-850/60 last:border-0">
                      <span>{name}</span>
                      <span className="text-[#00C49F] font-bold uppercase text-[8px] tracking-widest">Verificado SAT</span>
                    </div>
                  ))}
                </div>
              </div>
